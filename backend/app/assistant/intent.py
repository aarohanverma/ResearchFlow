    ...
    *,
    ...
    try:
        ...
        system = (
            ...
            "  • Classify complexity HONESTLY based on what the user is\n"
            "    actually asking. The orchestrator uses this to route depth:\n"
            "    misclassifying a deep research question as 'single' produces\n"
            "    shallow answers; misclassifying a greeting as 'deep' wastes\n"
            "    compute. Be accurate, not biased toward any tier.\n"
            "      - 'trivial' — greetings / acknowledgments / one-word\n"
            "        follow-ups / yes-no confirmations / pure conversational\n"
            "        chit-chat. No retrieval needed.\n"
            "      - 'single' — a focused, well-scoped question that one or\n"
            "        two tools can answer cleanly (definition, single-paper\n"
            "        question, narrow factual lookup, single-step explanation).\n"
            "      - 'deep' — multi-faceted research needing broad retrieval,\n"
            "        comparison across sources, synthesis of multiple\n"
            "        directions, novelty / SOTA scan, literature review,\n"
            "        critique of an idea, multi-step planning, or anything\n"
            "        that asks the assistant to 'compare X candidate\n"
            "        directions / synthesize a novel direction / evaluate\n"
            "        tradeoffs / explain mechanism end-to-end / survey a\n"
            "        field'. When in doubt and the question reads like real\n"
            "        research, prefer 'deep' over 'single'.\n"
